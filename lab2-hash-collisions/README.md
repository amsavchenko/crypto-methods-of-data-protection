...
## Структура 
```
├── bd_collisions/          # посчитанные коллизии (атака на основе парадокса дня рождений)
├── plots/                  # графики
├── pollard_collisions/     # посчитанные коллизии (атака на основе Ро-метода Полларда)
├── collisions.ipynb        # атака на основе парадокса дня рождений и все графики
├── pollard.py              # атака на основе Ро-метода Полларда 
```

# Условия:
Условия взяты [здесь](https://github.com/CryptoCourse/CryptoLabs/blob/master/Impl/HashAndEnemies.md). 
