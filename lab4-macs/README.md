...
# Условия
Оригинал условий [здесь](https://github.com/CryptoCourse/CryptoLabs/blob/master/docs/MacsImplementation.md).
...
- возвращающий результат вычисления кода аутентичности, для всех запрошенных блоков.
...
- проверяющий код аутентичности для прозвольных данных, используя метод `ComputeMac`
